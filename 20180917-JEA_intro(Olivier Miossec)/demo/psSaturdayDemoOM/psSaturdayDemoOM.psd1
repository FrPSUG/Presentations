#
# Manifeste de module pour le module « psSaturdayDemoOM »
#
# Généré par : olivi
#
# Généré le : 12/08/2018
#

@{

# Module de script ou fichier de module binaire associé à ce manifeste
RootModule = 'psSaturdayDemoOM.psm1'
...
GUID = 'bd25e349-db6a-4b56-b015-61a22c781909'
...
Copyright = '(c) 2018 olivi. Tous droits réservés.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'This is not a real Module ! The purpose of this module is to demonstrate how to use JEA'
